...
namespace Async_Inn.Controllers
{
    public class HotelRoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HotelsID,RoomNumber,RoomsID,Rate,PetFriendly")] HotelRooms hotelRooms)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HotelsID,RoomNumber,RoomsID,Rate,PetFriendly")] HotelRooms hotelRooms)
        {
